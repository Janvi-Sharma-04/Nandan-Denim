...
const Denim = () => {
  ...
  <Header/>
    <div>
      ...
      {/* Inquiry Form */}
      <div className="min-h-screen mt-10 flex items-center justify-center px-4 py-10 bg-cover bg-center bg-no-repeat bg-[url('./imgs/products/denim/denimbgimg.jpg')]">
